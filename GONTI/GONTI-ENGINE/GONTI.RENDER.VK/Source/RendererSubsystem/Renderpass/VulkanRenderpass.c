...
void gontiVkRenderpassEnd(GontiVulkanCommandBuffer* commandBuffer, GontiVulkanRenderpass* renderpass) {
    vkCmdEndRenderPass(commandBuffer->handle);
    commandBuffer->state = COMMAND_BUFFER_STATE_RECORDING;
}
void gontiVkRenderpassDestroy(GontiVulkanContext* context, GontiVulkanRenderpass* renderpass) {
