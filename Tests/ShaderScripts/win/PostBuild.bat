...
"%VULKAN_SDK%/bin/glslc.exe" -fshader-stage=vert Tests/Assets/shaders/Builtin.ObjectShader.vert.glsl -o Tests/Build/assets/shaders/Builtin.ObjectShader.vert.spv
...
"%VULKAN_SDK%/bin/glslc.exe" -fshader-stage=frag Tests/Assets/shaders/Builtin.ObjectShader.frag.glsl -o Tests/Build/assets/shaders/Builtin.ObjectShader.frag.spv
if %ERRORLEVEL% NEQ 0 (echo Error: %ERRORLEVEL% && exit)
