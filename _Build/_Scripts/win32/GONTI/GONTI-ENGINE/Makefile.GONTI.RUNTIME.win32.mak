...
ASSEMBLY := GONTI.RUNTIME
EXTENSION := .dll
COMPILER_FLAGS := -g -Wvarargs -Wall -Werror
INCLUDE_FLAGS := -I"$(VULKAN_SDK)/include" -I../../../../..
LINKER_FLAGS := -g -shared -luser32 -lvulkan-1 -lGONTI.CORE -lGONTI.RENDER.VK -lGONTI.RENDER -L"$(VULKAN_SDK)/lib" -L$(BUILD)/GONTI.CORE -L$(OBJ)/GONTI.CORE -L$(BUILD)/GONTI.RENDER.VK -L$(OBJ)/GONTI.RENDER.VK -L$(BUILD)/GONTI.RENDER -L$(OBJ)/GONTI.RENDER
