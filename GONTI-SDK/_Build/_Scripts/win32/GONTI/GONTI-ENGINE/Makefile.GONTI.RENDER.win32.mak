...
LINKER_FLAGS := -g -shared -luser32 -lvulkan-1 -lGONTI.CORE -lGONTI.RENDER.VK -L"$(VULKAN_SDK)/lib" -L$(BUILD)/GONTI.CORE -L$(OBJ)/GONTI.CORE -L$(BUILD)/GONTI.RENDER.VK -L$(OBJ)/GONTI.RENDER.VK
